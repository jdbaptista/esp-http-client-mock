...
#define ESP_HTTP_CLEINT_OPEN(client, write_len) esp_http_client_open(client, write_len)
...
#define ESP_HTTP_CLEINT_OPEN(client, write_len) wrap_esp_http_client_open(client, write_len)
