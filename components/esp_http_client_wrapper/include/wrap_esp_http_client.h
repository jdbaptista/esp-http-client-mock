...
#define ESP_HTTP_CLIENT_FETCH_HEADERS(client) wrap_esp_http_client_fetch_headers(client)
...
#define ESP_HTTP_CLIENT_FETCH_HEADERS(client) esp_http_client_fetch_headers(client)
